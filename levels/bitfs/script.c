...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(MODEL_BULLY, 0, 0, 0, 0, 0, 0, 0x00000001, bhvSmallBully),
    OBJECT(MODEL_BULLY, 0, 0, 0, 0, 0, 0, 0x00000001, bhvSmallBully),
    OBJECT(MODEL_BULLY, 0, 0, 0, 0, 0, 0, 0x00000001, bhvSmallBully),
    OBJECT(MODEL_BULLY, 0, 0, 0, 0, 0, 0, 0x00000001, bhvSmallBully),
    OBJECT(MODEL_BULLY, 0, 0, 0, 0, 0, 0, 0x00000001, bhvSmallBully),
...
const LevelScript level_bitfs_entry[] = {
    ...
    AREA(/*index*/ 1, bitfs_geo_0007A0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -7577, -1764,  0, /*angle*/ 0, 90, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSpinAirborneWarp),
