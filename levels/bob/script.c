...
static const LevelScript script_func_local_1[] = {
    ...
    // Advanced objects
    OBJECT(MODEL_BOBOMB_BUDDY,0,0,0,0,0,0, 0x00000001, bhvBobomb),
    OBJECT(MODEL_BOBOMB_BUDDY,0,0,0,0,0,0, 0x00000001, bhvBobomb),
    OBJECT(MODEL_BOBOMB_BUDDY,0,0,0,0,0,0, 0x00000001, bhvBobomb),
    OBJECT(MODEL_BOBOMB_BUDDY,0,0,0,0,0,0, 0x00000001, bhvBobomb),
    OBJECT(MODEL_BOBOMB_BUDDY,0,0,0,0,0,0, 0x00000001, bhvBobomb),
    ...
    OBJECT(MODEL_CHUCKYA, 0,0,0,0,0,0, 0x00000001, bhvChuckya),
    OBJECT(MODEL_CHUCKYA, 0,0,0,0,0,0, 0x00000001, bhvChuckya),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvFirePiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvFirePiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvFirePiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvFirePiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvFirePiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvPiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvPiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvPiranhaPlant),
...
static const LevelScript script_func_local_2[] = {
    OBJ_WITH_ACTS_NOT_NS(/*model*/ MODEL_NONE,                  /*pos*/  1535, 3840, -5561, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000,       /*beh*/ bhvBobBowlingBallSpawner,  /*acts*/ ACT_1 | ACT_2),
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_NONE,                  /*pos*/  1535, 3840, -5561, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000,       /*beh*/ bhvTtmBowlingBallSpawner,  /*acts*/ ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJ_WITH_ACTS_NOT_NS(/*model*/ MODEL_NONE,                  /*pos*/   524, 2825, -5400, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00020000,       /*beh*/ bhvBobBowlingBallSpawner,  /*acts*/ ACT_1 | ACT_2),
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_NONE,                  /*pos*/   524, 2825, -5400, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00020000,       /*beh*/ bhvTtmBowlingBallSpawner,  /*acts*/ ACT_3 | ACT_4 | ACT_5 | ACT_6),
    ...
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_BOWLING_BALL,          /*pos*/   -93,  886, -3414, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000,       /*beh*/ bhvPitBowlingBall,         /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJ_WITH_ACTS_NOT_NS(/*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -5723,  140,  6017, /*angle*/ 0, 0, 0,   /*behParam*/ DIALOG_002 << 16, /*beh*/ bhvBobombBuddy,            /*acts*/ ACT_1),
    OBJ_WITH_ACTS_NOT_NS(/*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -6250,    0,  6680, /*angle*/ 0, 0, 0,   /*behParam*/ DIALOG_001 << 16, /*beh*/ bhvBobombBuddy,            /*acts*/ ACT_1),
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -5723,  140,  6017, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000,       /*beh*/ bhvBobombBuddyOpensCannon, /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -6250,    0,  6680, /*angle*/ 0, 0, 0,   /*behParam*/ DIALOG_003 << 16, /*beh*/ bhvBobombBuddy,            /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJ_WITH_ACTS_NOT_NS(/*model*/ MODEL_CANNON_BASE,           /*pos*/ -5694,  128,  5600, /*angle*/ 0, 135, 0, /*behParam*/ 0x00010000,       /*beh*/ bhvWaterBombCannon,        /*acts*/ ACT_1),
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_DL_CANNON_LID,         /*pos*/ -5694,  128,  5600, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000,       /*beh*/ bhvCannonClosed,           /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJ_WITH_ACTS_NS    (/*model*/ MODEL_NONE,                  /*pos*/  3304, 4242, -4603, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000,       /*beh*/ bhvKoopaRaceEndpoint,      /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
    OBJECT              (/*model*/ MODEL_KOOPA_WITH_SHELL,      /*pos*/  3400,  770,  6500, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00010000,       /*beh*/ bhvKoopa),
    RETURN(),
};

static const LevelScript script_func_local_3[] = {
    OBJECT          (/*model*/ MODEL_KING_BOBOMB,           /*pos*/  1636, 4242, -5567, /*angle*/ 0, -147, 0, /*behParam*/ 0x00000000, /*beh*/ bhvKingBobomb),
    OBJ_WITH_ACTS_NS(/*model*/ MODEL_KOOPA_WITH_SHELL,      /*pos*/ -4004,    0,  5221, /*angle*/ 0, 0, 0,    /*behParam*/ 0x01020000, /*beh*/ bhvKoopaTheQuick, /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
