...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_BUB,         /*pos*/ -3071, -2000,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBub),
    OBJECT(/*model*/ MODEL_BUB,         /*pos*/ -3071, -3000,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBub),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT      (/*model*/ MODEL_MANTA_RAY, /*pos*/ -4640, -1380,  40, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ bhvMantaRay),
    OBJECT_EXTRA(/*model*/ MODEL_NONE,      /*pos*/     0,     0,   0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00110000, /*beh*/ bhvCoinFormation),
    RETURN(),
};
...
static const LevelScript script_func_local_5[] = {
    ...
    OBJECT      (/*model*/ MODEL_NONE, /*pos*/ 5513,  1200,   900, /*angle*/ 0, 0, 0, /*behParam*/ 0x02000000, /*beh*/ bhvHiddenRedCoinStar),
    OBJECT      (/*model*/ MODEL_NONE, /*pos*/ 3404, -3319,  -489, /*angle*/ 0, 0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvJetStreamRingSpawner),
    OBJECT      (/*model*/ MODEL_STAR, /*pos*/ 2030, -3700, -2780, /*angle*/ 0, 0, 0, /*behParam*/ 0x05000000, /*beh*/ bhvStar),
    OBJECT_EXTRA(/*model*/ MODEL_NONE, /*pos*/    0,     0,     0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00110000, /*beh*/ bhvCoinFormation),
    RETURN(),
};
