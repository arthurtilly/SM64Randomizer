...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(MODEL_GOOMBA, 0,0,0,0,0,0, 0x00000001, bhvGoomba),
    OBJECT(MODEL_GOOMBA, 0,0,0,0,0,0, 0x00000001, bhvGoomba),
    OBJECT(MODEL_WHOMP, 0,0,0,0,0,0, 0x00000001, bhvSmallWhomp),
    OBJECT(MODEL_WHOMP, 0,0,0,0,0,0, 0x00000001, bhvSmallWhomp),
    OBJECT(MODEL_WHOMP, 0,0,0,0,0,0, 0x00000001, bhvSmallWhomp),
    OBJECT(MODEL_WHOMP, 0,0,0,0,0,0, 0x00000001, bhvSmallWhomp),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvPiranhaPlant),
    OBJECT(MODEL_PIRANHA_PLANT, 0,0,0,0,0,0, 0x00000001, bhvPiranhaPlant),
    OBJECT(MODEL_THWOMP, 0,0,0,0,0,0, 0x00000001, bhvThwomp),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_WF_KICKABLE_BOARD,           /*pos*/    13, 3584, -1407, /*angle*/ 0, 315, 0, /*behParam*/ 0x00000000, /*beh*/ bhvKickableBoard),
    OBJECT(/*model*/ MODEL_1UP,                         /*pos*/  -384, 3584,     6, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhv1Up),
...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT(/*model*/ MODEL_WF_TOWER_DOOR,     /*pos*/  -511, 3584,     0, /*angle*/ 0,    0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTowerDoor),
    OBJECT(/*model*/ MODEL_BOBOMB_BUDDY,      /*pos*/ -1700, 1140,  3500, /*angle*/ 0,    0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBobombBuddyOpensCannon),
    OBJECT(/*model*/ MODEL_HOOT,              /*pos*/  2560,  700,  4608, /*angle*/ 0,    0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvHoot),
    RETURN(),
};

static const LevelScript script_func_local_4[] = {
    OBJECT(/*model*/ MODEL_WHOMP, /*pos*/     0, 3584,    0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvWhompKingBoss),
    OBJECT(/*model*/ MODEL_STAR,  /*pos*/   300, 5550,    0, /*angle*/ 0, 0, 0, /*behParam*/ 0x01000000, /*beh*/ bhvStar),
    OBJECT(/*model*/ MODEL_STAR,  /*pos*/ -2500, 1500, -750, /*angle*/ 0, 0, 0, /*behParam*/ 0x02000000, /*beh*/ bhvStar),
    OBJECT(/*model*/ MODEL_NONE,  /*pos*/  4600,  550, 2500, /*angle*/ 0, 0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvHiddenRedCoinStar),
    OBJECT(/*model*/ MODEL_STAR,  /*pos*/  2880, 4300,  190, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ bhvStar),
    OBJECT(/*model*/ MODEL_STAR,  /*pos*/   590, 2450, 2650, /*angle*/ 0, 0, 0, /*behParam*/ 0x05000000, /*beh*/ bhvStar),
    RETURN(),
};
