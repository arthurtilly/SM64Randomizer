...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_8_STARS, /*pos*/ -2706,   512, -1409, /*angle*/ 0,  45, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_BITDW), /*beh*/ bhvStarDoor),
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_8_STARS, /*pos*/ -2598,   512, -1517, /*angle*/ 0, 225, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_BITDW), /*beh*/ bhvStarDoor),
    OBJECT(/*model*/ MODEL_CASTLE_KEY_DOOR,          /*pos*/ -1100,   512, -1074, /*angle*/ 0,   0, 0, /*behParam*/ 0xFE030000,                 /*beh*/ bhvDoorWarp),
    OBJECT(/*model*/ MODEL_CASTLE_KEY_DOOR,          /*pos*/  -946,   512, -1074, /*angle*/ 0, 180, 0, /*behParam*/ 0xFE040000,                 /*beh*/ bhvDoorWarp),
    OBJECT(/*model*/ MODEL_CASTLE_KEY_DOOR,          /*pos*/ -1100, -1074,   922, /*angle*/ 0,   0, 0, /*behParam*/ 0xFF050000,                 /*beh*/ bhvDoorWarp),
    OBJECT(/*model*/ MODEL_CASTLE_KEY_DOOR,          /*pos*/  -946, -1074,   922, /*angle*/ 0, 180, 0, /*behParam*/ 0xFF060000,                 /*beh*/ bhvDoorWarp),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_50_STARS, /*pos*/ -281, 2253, 4762, /*angle*/ 0,   0, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_TIPPY), /*beh*/ bhvStarDoor),
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_50_STARS, /*pos*/ -127, 2253, 4762, /*angle*/ 0, 180, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_TIPPY), /*beh*/ bhvStarDoor),
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_70_STARS, /*pos*/ -281, 3174, 3772, /*angle*/ 0,   0, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_BITS),  /*beh*/ bhvStarDoor),
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_70_STARS, /*pos*/ -127, 3174, 3772, /*angle*/ 0, 180, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_BITS),  /*beh*/ bhvStarDoor),
...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_30_STARS, /*pos*/ 307, -1074, 2074, /*angle*/ 0,  90, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_DDD), /*beh*/ bhvStarDoor),
    OBJECT(/*model*/ MODEL_CASTLE_STAR_DOOR_30_STARS, /*pos*/ 307, -1074, 1920, /*angle*/ 0, 270, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_DDD), /*beh*/ bhvStarDoor),
...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 1, castle_geo_001400),
        ...
        OBJECT(/*model*/ MODEL_CASTLE_DOOR_1_STAR,  /*pos*/  256,    0, -1074, /*angle*/ 0,   0, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_WF),               /*beh*/ bhvDoor),
        OBJECT(/*model*/ MODEL_CASTLE_DOOR_1_STAR,  /*pos*/  644,  614, -1476, /*angle*/ 0, 315, 0, /*behParam*/ DOOR_PARAM(STAR_REQ_PSS),              /*beh*/ bhvDoor),
