...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(MODEL_SPINDRIFT, 0,0,0,0,0,0, 0x00000001, bhvSpindrift),
    OBJECT(MODEL_SPINDRIFT, 0,0,0,0,0,0, 0x00000001, bhvSpindrift),
    OBJECT(MODEL_MR_BLIZZARD_HIDDEN, 0,0,0,0,0,0, 0x00000001, bhvMrBlizzard),
    OBJECT(MODEL_MR_BLIZZARD_HIDDEN, 0,0,0,0,0,0, 0x00000001, bhvMrBlizzard),
    OBJECT(MODEL_MR_BLIZZARD_HIDDEN, 0,0,0,0,0,0, 0x00000001, bhvMrBlizzard),
    OBJECT(MODEL_MR_BLIZZARD_HIDDEN, 0,0,0,0,0,0, 0x00000001, bhvMrBlizzard),
    OBJECT(MODEL_MR_BLIZZARD_HIDDEN, 0,0,0,0,0,0, 0x00000001, bhvMrBlizzard),
    ...
    OBJECT(MODEL_CHUCKYA, 0,0,0,0,0,0, 0x00000001, bhvChuckya),
    OBJECT(/*model*/ MODEL_PENGUIN,          /*pos*/  2650, -3735,  3970, /*angle*/ 0,   0, 0, /*behParam*/ 0x00010001, /*beh*/ bhvSmallPenguin),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_CCM_SNOWMAN_BASE, /*pos*/  2560,  2662, -1122, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSnowmansBottom),
    RETURN(),
};

static const LevelScript script_func_local_3[] = {
    OBJECT(/*model*/ MODEL_NONE,             /*pos*/  2665, -4607,  4525, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCcmTouchedStarSpawn),
    OBJECT(/*model*/ MODEL_PENGUIN,          /*pos*/  3450, -4700,  4550, /*angle*/ 0,   0, 0, /*behParam*/ 0x01000000, /*beh*/ bhvTuxiesMother),
    OBJECT(/*model*/ MODEL_NONE,             /*pos*/  4200,  -927,   400, /*angle*/ 0,   0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvHiddenRedCoinStar),
    OBJECT(/*model*/ MODEL_CCM_SNOWMAN_HEAD, /*pos*/ -4230, -1169,  1813, /*angle*/ 0, 270, 0, /*behParam*/ 0x04000000, /*beh*/ bhvSnowmansHead),
    OBJECT(/*model*/ MODEL_STAR,             /*pos*/ -2000, -2200, -3000, /*angle*/ 0,   0, 0, /*behParam*/ 0x05000000, /*beh*/ bhvStar),
    RETURN(),
};
...
static const LevelScript script_func_local_4[] = {
    ...
    OBJ_WITH_ACTS_NS(/*model*/ MODEL_PENGUIN, /*pos*/ -4952,  6656, -6075, /*angle*/ 0, 270, 0, /*behParam*/ 0x02000000, /*beh*/ bhvRacingPenguin,   /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
