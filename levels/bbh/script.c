...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(MODEL_BOO, 0,0,0,0,0,0, 0x00000001, bhvGhostHuntBoo),
    OBJECT(MODEL_BOO, 0,0,0,0,0,0, 0x00000001, bhvGhostHuntBoo),
    OBJECT(MODEL_BOO, 0,0,0,0,0,0, 0x00000001, bhvGhostHuntBoo),
    ...
    OBJECT(MODEL_SCUTTLEBUG, 0,0,0,0,0,0, 0x00000001, bhvScuttlebug),
    OBJECT(MODEL_SCUTTLEBUG, 0,0,0,0,0,0, 0x00000001, bhvScuttlebug),
    OBJECT(MODEL_MAD_PIANO, 0,0,0,0,0,0, 0x00000001, bhvMadPiano),
    OBJECT(MODEL_MAD_PIANO, 0,0,0,0,0,0, 0x00000001, bhvMadPiano),
    OBJECT(MODEL_MAD_PIANO, 0,0,0,0,0,0, 0x00000001, bhvMadPiano),
    OBJECT(MODEL_MAD_PIANO, 0,0,0,0,0,0, 0x00000001, bhvMadPiano),
...
static const LevelScript script_func_local_3[] = {
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/  1000,    50,  1000, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBigBoo),
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/    20,   100,  -908, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBoo),
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/  3150,   100,   398, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBoo),
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/ -2000,   150,  -800, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBoo),
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/  2851,   100,  2289, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBoo),
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/ -1551,   100, -1018, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvGhostHuntBoo),
    OBJECT(/*model*/ MODEL_BBH_STAIRCASE_STEP,         /*pos*/   973,     0,   517, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvHiddenStaircaseStep),
    OBJECT(/*model*/ MODEL_BBH_STAIRCASE_STEP,         /*pos*/   973,  -206,   717, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvHiddenStaircaseStep),
    OBJECT(/*model*/ MODEL_BBH_STAIRCASE_STEP,         /*pos*/   973,  -412,   917, /*angle*/ 0, 0, 0,   /*behParam*/ 0x00000000, /*beh*/ bhvHiddenStaircaseStep),
    OBJECT(/*model*/ MODEL_NONE,                       /*pos*/   990, -2146,  -908, /*angle*/ 0, -45, 0, /*behParam*/ 0x00030000, /*beh*/ bhvFlamethrower),
    OBJECT(/*model*/ MODEL_NONE,                       /*pos*/ -1100, -2372,  1100, /*angle*/ 0, 135, 0, /*behParam*/ 0x01000000, /*beh*/ bhvMerryGoRoundBooManager),
    OBJECT(/*model*/ MODEL_BOO,                        /*pos*/  1030,  1922,  2546, /*angle*/ 0, -90, 0, /*behParam*/ 0x04000000, /*beh*/ bhvBalconyBigBoo),
...
static const LevelScript script_func_local_4[] = {
    OBJECT      (/*model*/ MODEL_STAR,            /*pos*/ -2030, 1350,  1940, /*angle*/ 0,  0, 0, /*behParam*/ 0x02000000, /*beh*/ bhvStar),
    OBJECT      (/*model*/ MODEL_NONE,            /*pos*/  -204, 1100,  1576, /*angle*/ 0,  0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvHiddenRedCoinStar),
    OBJECT      (/*model*/ MODEL_NONE,            /*pos*/   923, 1741,  -332, /*angle*/ 0, 18, 0, /*behParam*/ 0x05010000, /*beh*/ bhvBigMrI),
    OBJECT_EXTRA(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/     0,    0,     0, /*angle*/ 0,  0, 0, /*behParam*/ 0x00020000, /*beh*/ bhvExclamationBox),
    RETURN(),
};
