...
UNUSED static const Lights1 heave_ho_lights_unused1 = gdSPDefLights1(
    0x2c, 0x2c, 0x2c,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// Unreferenced light group
UNUSED static const Lights1 heave_ho_lights_unused2 = gdSPDefLights1(
    0x3f, 0x38, 0x00,
    0xff, 0xe3, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
UNUSED static const Lights1 heave_ho_lights_unused3 = gdSPDefLights1(
    0x3f, 0x00, 0x00,
...
// Unreferenced light group
UNUSED static const Lights1 heave_ho_lights_unused4 = gdSPDefLights1(
    0x3b, 0x38, 0x21,
    0xec, 0xe3, 0x84, 0x28, 0x28, 0x28
);

// Unreferenced light group
UNUSED static const Lights1 heave_ho_lights_unused5 = gdSPDefLights1(
    0x32, 0x32, 0x32,
...
// 0x0500E9C8
ALIGNED8 static const Texture heave_ho_seg5_texture_0500E9C8_fast[] = {
#include "actors/heave_ho/heave-ho_fast_face.rgba16.inc.c"
};
...
// 0x05011D98 - 0x05011DE0
const Gfx heave_ho_seg5_dl_05011D98_fast[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, heave_ho_seg5_texture_0500E9C8_fast),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&heave_ho_seg5_lights_05011BC8.l, 1),
    gsSPLight(&heave_ho_seg5_lights_05011BC8.a, 2),
...
// 0x05011EC0 - 0x05011F50
const Gfx heave_ho_seg5_dl_05011EC0_fast[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(heave_ho_seg5_dl_05011D98_fast),
    gsSPDisplayList(heave_ho_seg5_dl_05011DE0),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 6, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
