      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_BILLBOARD(),
               GEO_OPEN_NODE(),
                  GEO_DISPLAY_LIST_FAST(LAYER_ALPHA, skeeter_seg6_dl_06000A08),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_BILLBOARD(),
                     GEO_OPEN_NODE(),
                        GEO_DISPLAY_LIST_FAST(LAYER_ALPHA, skeeter_seg6_dl_06000BD8),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        GEO_BILLBOARD(),
                        GEO_OPEN_NODE(),
                           GEO_DISPLAY_LIST_FAST(LAYER_ALPHA, skeeter_seg6_dl_06000AF0),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE, 216, 0, 0, NULL),
                  GEO_CLOSE_NODE(),
