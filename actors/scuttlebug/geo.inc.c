                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           GEO_BILLBOARD(),
                           GEO_OPEN_NODE(),
                              GEO_DISPLAY_LIST_FAST(LAYER_ALPHA, scuttlebug_seg6_dl_06013AE8),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                        GEO_ANIMATED_PART_FAST(LAYER_ALPHA, 0, 0, 0, scuttlebug_seg6_dl_06013CB8),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           GEO_BILLBOARD(),
                           GEO_OPEN_NODE(),
                              GEO_DISPLAY_LIST_FAST(LAYER_ALPHA, scuttlebug_seg6_dl_06013BD0),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                        GEO_ANIMATED_PART_FAST(LAYER_ALPHA, 0, 0, 0, scuttlebug_seg6_dl_06013DA0),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
