...
u8 gRandomSongs[148] = { SEQ_MENU_TITLE_SCREEN, SEQ_LEVEL_GRASS,          SEQ_LEVEL_INSIDE_CASTLE,    SEQ_LEVEL_WATER,
                      ...
                      SEQ_LEVEL_BOSS_KOOPA_FINAL, SEQ_MENU_FILE_SELECT, 
    SEQ_LEVEL_22,
    SEQ_LEVEL_23,
    SEQ_LEVEL_24,
    SEQ_LEVEL_25,
...
struct OptionsSettings gPresets[6] = {
    {{{0, /* pad */ 0, 0, 1, 1, 1, 1, 0, 2, 1, 1, 1, 7, 0}}, {{2, 1, 1, 1, 2, 0, 1}}},
    {{{0, /* pad */ 0, 0, 1, 1, 1, 1, 0, 2, 1, 1, 1, 10, 0}}, {{2, 1, 1, 1, 2, 0, 1}}},
    {{{0, /* pad */ 0, 0, 1, 1, 1, 1, 0, 2, 1, 1, 1, 12, 0}}, {{2, 1, 1, 1, 2, 0, 1}}},
    {{{0, /* pad */ 0, 1, 1, 1, 1, 1, 0, 2, 1, 1, 1, 7, 0}}, {{2, 1, 1, 1, 2, 0, 1}}},
    {{{0, /* pad */ 0, 1, 1, 1, 1, 1, 0, 2, 1, 1, 1, 10, 0}}, {{2, 1, 1, 1, 2, 0, 1}}},
    {{{0, /* pad */ 0, 1, 1, 1, 1, 1, 0, 2, 1, 1, 1, 12, 0}}, {{2, 1, 1, 1, 2, 0, 1}}},
};
...
char *songlist[] = {
    ...
    "Super Mario 64 - Metallic Mario",
    "Super Mario 64 - Koopa's Road",
    "Race Fanfare", // not used
    "Super Mario 64 - Stage Boss",
    "Super Mario 64 - Ultimate Koopa",
    "Super Mario 64 - File Select",
    "Super Mario 64 - Powerful Mario", // duplicate, not used
    "Super Mario 64 - Title Theme", // duplicate, not used
    ...
    "Castlevania: Order of Ecclesia - A Prologue",
    ...
    "Kirby Super Star - Mine Cart Riding",
    "TLoZ: Majora's Mask - Clock Town Day 1",
    ...
    "Yoshi's Island - Crystal Caves",
    "TLoZ: Ocarina of Time - Water Temple",
    "Wave Race 64 - Sunny Beach",
    "Whomp's Floating Habitat (Original by MariosHub)",
    "TLoZ: Ocarina of Time - Kokiri Forest",
    "TLoZ: Ocarina of Time - Zora's Domain",
    "TLoZ: Ocarina of Time - Kakariko Village",
    "A Morning Jog (Original by TheGael95)",
    "TLoZ: The Wind Waker - Outset Island",
    ...
    "Sonic Adventure - Windy Hill",
    "Super Paper Mario - The Overthere Stair",
    ...
    "Mario and Luigi: Bowser's Inside Story - Bumpsy Plains",
    "Super Mario World - Athletic Theme",
    "TLoZ: Skyward Sword - Skyloft",
    "Super Mario World - Castle",
    "Super Mario Galaxy - Comet Observatory",
    "Banjo-Kazooie - Freezeezy Peak",
    "Mario Kart DS - Waluigi Pinball",
    "Kirby 64: The Crystal Shards - Factory Inspection",
    "Donkey Kong 64 - Creepy Castle",
    "Paper Mario 64 - Forever Forest",
    "Super Mario Bros. - Bowser's Theme (Remix)",
    "TLoZ: Twilight Princess - Gerudo Desert",
    "Yoshi's Island - Overworld",
    "Mario and Luigi: Partners in Time - Gritzy Desert",
    "Donkey Kong 64 - Angry Aztec",
    "Mario and Luigi: Partners in Time - Yoshi's Village",
    "Touhou 10: Mountain of Faith - Youkai Mountain",
    "Mario and Luigi: Bowser's Inside Story - Deep Castle",
    "Paper Mario: The Thousand-Year Door - Petal Meadows",
    "Mario Party - Yoshi's Tropical Island",
    "Super Mario 3D World - Piranha Creek",
    "Final Fantasy VII - Forested Temple",
    "Paper Mario 64 - Dry Dry Desert",
    "Rayman - Band Land",
    ...
    "TLoZ: Majora's Mask - Stone Tower Temple",
    ...
    "Super Paper Mario - Floro Caverns",
    "Yoshi's Story - Title Theme",
    "TLoZ: Twilight Princess - Lake Hylia",
