...
enum MenuButtonTypes {
    ...
    MENU_BUTTON_MONO,
    MENU_BUTTON_HEADSET,
    MENU_BUTTON_SOUND_MODE_MAX,

    MENU_BUTTON_SEED_MIN = MENU_BUTTON_SOUND_MODE_MAX,
    MENU_BUTTON_SELECT_SEED_RETURN = MENU_BUTTON_SEED_MIN,
    MENU_BUTTON_SELECT_SEED_RESET,
    MENU_BUTTON_SELECT_SEED_OPTIONS,
    ...
    MENU_BUTTON_OPTION_MAX = MENU_BUTTON_SEED_MAX
};
