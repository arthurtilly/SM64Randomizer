...
SRC_DIRS += src src/boot src/game src/engine src/audio src/menu src/buffers src/vc actors levels bin data assets asm lib sound
...
$(BUILD_DIR)/src/game/randomizer.o:  $(BUILD_DIR)/include/text_strings.h
