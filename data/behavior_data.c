...
const BehaviorScript bhvSmallPenguin[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_IMPORTANT),
    DROP_TO_FLOOR(),
    LOAD_ANIMATIONS(oAnimations, penguin_seg5_anims_05008B74),
...
const BehaviorScript bhvExclamationBox[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    RANDOMIZE_OBJ(RAND_TYPE_MAX_VARIATION | RAND_TYPE_IMPORTANT | RAND_TYPE_SAFE),
...
const BehaviorScript bhvStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    RANDOMIZE_OBJ(RAND_TYPE_MAX_VARIATION | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_LIMITED_BBH_HMC_SPAWNS | RAND_TYPE_IMPORTANT | RAND_TYPE_HARD_HEIGHT),
    CALL_NATIVE(bhv_init_room),
...
const BehaviorScript bhvHiddenRedCoinStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    RANDOMIZE_OBJ(RAND_TYPE_MAX_VARIATION | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_LIMITED_BBH_HMC_SPAWNS | RAND_TYPE_IMPORTANT | RAND_TYPE_RANDO_STAR),
    DELAY(1),
...
const BehaviorScript bhvRedCoin[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    RANDOMIZE_OBJ(RAND_TYPE_MIN_VARIATION | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_LIMITED_BBH_HMC_SPAWNS | RAND_TYPE_IMPORTANT | RAND_TYPE_HARD_HEIGHT),
    BILLBOARD(),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oAnimState, OBJ_ANIM_STATE_INIT_ANIM),
    CALL_NATIVE(bhv_init_room),
...
const BehaviorScript bhvBowserCourseRedCoinStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    RANDOMIZE_OBJ(RAND_TYPE_MAX_VARIATION | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_IMPORTANT | RAND_TYPE_RANDO_STAR),
    CALL_NATIVE(bhv_hidden_red_coin_star_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvHiddenStarTrigger[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    RANDOMIZE_OBJ(RAND_TYPE_MIN_VARIATION | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_IMPORTANT | RAND_TYPE_HARD_HEIGHT),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 100),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvTreasureChestBottom[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    RANDOMIZE_OBJ(RAND_TYPE_GROUNDED | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_SPAWN_FAR_FROM_WALLS | RAND_TYPE_IMPORTANT),
    DROP_TO_FLOOR(),
