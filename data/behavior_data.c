...
const BehaviorScript bhvExclamationBox[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    RANDOMIZE_OBJ(RAND_TYPE_MAX_VARIATION | RAND_TYPE_IMPORTANT),
...
const BehaviorScript bhvStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    RANDOMIZE_OBJ(RAND_TYPE_MAX_VARIATION | RAND_TYPE_CAN_BE_UNDERWATER | RAND_TYPE_LIMITED_BBH_HMC_SPAWNS | RAND_TYPE_IMPORTANT),
    CALL_NATIVE(bhv_init_room),
